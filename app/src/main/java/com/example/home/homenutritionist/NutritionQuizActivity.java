...
public class NutritionQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizLinearLayout = (RelativeLayout) findViewById(R.id.nutritionquiz);
        handler = new Handler();
        quizFlagNameList = new ArrayList<>();
...
//result.setText("");
            ...
            if (correctAnswers == FLAGS_IN_QUIZ) {
                ...
                Toast.makeText(NutritionQuizActivity.this, getString(R.string.result, totalGuesses, (correctAnswers / (double) totalGuesses) * 100), Toast.LENGTH_SHORT).show();
//questionNumberTextView.setText(getString(R.string.question, (correctAnswers), FLAGS_IN_QUIZ));
            } else {
// questionNumberTextView.setText(getString(R.string.question, (correctAnswers), FLAGS_IN_QUIZ));
                handler.postDelayed(
