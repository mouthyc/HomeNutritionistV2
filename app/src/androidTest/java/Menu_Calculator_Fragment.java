...
public class Menu_Calculator_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button button = (Button) rootview.findViewById(R.id.sugar);
        Button button1 = (Button) rootview.findViewById(R.id.oil);
        Button button2 = (Button) rootview.findViewById(R.id.pepper);
        Button button3 = (Button) rootview.findViewById(R.id.oregano);
        Button button4 = (Button) rootview.findViewById(R.id.mushroom);
        Button button5 = (Button) rootview.findViewById(R.id.apple);
        Button button6 = (Button) rootview.findViewById(R.id.banana);
        Button button7 = (Button) rootview.findViewById(R.id.orange);
        Button button8 = (Button) rootview.findViewById(R.id.pineapple);
        Button button9 = (Button) rootview.findViewById(R.id.onion);
        Button button10 = (Button) rootview.findViewById(R.id.beef);
        Button button11 = (Button) rootview.findViewById(R.id.chicken);
        Button button12 = (Button) rootview.findViewById(R.id.lamb);
        Button button13 = (Button) rootview.findViewById(R.id.pork);
        Button button14 = (Button) rootview.findViewById(R.id.duck);
        Button button15 = (Button) rootview.findViewById(R.id.rice);
        Button button16 = (Button) rootview.findViewById(R.id.noodle);
        Button button17 = (Button) rootview.findViewById(R.id.corn);
        Button button18 = (Button) rootview.findViewById(R.id.bread);
        Button button19 = (Button) rootview.findViewById(R.id.fish);
        Button button20 = (Button) rootview.findViewById(R.id.salmon);
        Button button21 = (Button) rootview.findViewById(R.id.catfish);
        Button button22 = (Button) rootview.findViewById(R.id.cuttlefish);
        Button button23 = (Button) rootview.findViewById(R.id.squid);
        Button button24 = (Button) rootview.findViewById(R.id.shrimp);
        Button button25 = (Button) rootview.findViewById(R.id.crab);
        Button button26 = (Button) rootview.findViewById(R.id.shellfish);
        Button button27 = (Button) rootview.findViewById(R.id.other);
        Button button28 = (Button) rootview.findViewById(R.id.reset);
        Button button29 = (Button) rootview.findViewById(R.id.checkInput);
        ImageView image1 = (ImageView) rootview.findViewById(R.id.red);
        ImageView image2 = (ImageView) rootview.findViewById(R.id.yellow);
        ImageView image3 = (ImageView) rootview.findViewById(R.id.green);
        ImageView image4 = (ImageView) rootview.findViewById(R.id.seasoning);
        ImageView image5 = (ImageView) rootview.findViewById(R.id.vegetable);
        ImageView image6 = (ImageView) rootview.findViewById(R.id.meat);
        ImageView image7 = (ImageView) rootview.findViewById(R.id.cereal);
        ImageView image8 = (ImageView) rootview.findViewById(R.id.seafood);
    ...
    public void clickSugar(View v) {
        EditText gram = (EditText) rootview.findViewById(R.id.totalGram);
...
// disallow user to click the button if the "totalGram" editText is empty to prevent the app from crashing
        ...
        TextView result = (TextView) rootview.findViewById(R.id.totalCalories);
...
// store the input (types of food and the appropriate amount) chosen by users
        ...
        if (value < 2400) {
            ImageView imgView = (ImageView) rootview.findViewById(R.id.green);
            imgView.setVisibility(View.VISIBLE);
            ImageView imgView2 = (ImageView) rootview.findViewById(R.id.red);
            imgView2.setVisibility(View.INVISIBLE);
            ImageView imgView3 = (ImageView) rootview.findViewById(R.id.yellow);
            imgView3.setVisibility(View.INVISIBLE);
        } else if (value >= 2400 && value < 2500) {
            ImageView imgView = (ImageView) rootview.findViewById(R.id.yellow);
            imgView.setVisibility(View.VISIBLE);
            ImageView imgView2 = (ImageView) rootview.findViewById(R.id.green);
            imgView2.setVisibility(View.INVISIBLE);
            ImageView imgView3 = (ImageView) rootview.findViewById(R.id.red);
            imgView3.setVisibility(View.INVISIBLE);
        } else {
            ImageView imgView = (ImageView) rootview.findViewById(R.id.red);
            imgView.setVisibility(View.VISIBLE);
            ImageView imgView2 = (ImageView) rootview.findViewById(R.id.green);
            imgView2.setVisibility(View.INVISIBLE);
            ImageView imgView3 = (ImageView) rootview.findViewById(R.id.yellow);
...
//reset the editText gram to null
    ...
    public void clickOther(View v) {
        EditText calories = (EditText) rootview.findViewById(R.id.caloriesOfOtherFood);
        if (calories.getText().toString().matches("")) {
            Toast.makeText(getActivity(), "Please enter the amount of calories ", Toast.LENGTH_SHORT).show();
            return;
        }
// disallow user to click the "other" button if the "caloriesOfOtherFood" editText is empty to prevent the app from crashing

        EditText nameOfOtherFood = (EditText) rootview.findViewById(R.id.nameOfOtherFood);
...
// display the name of food on the input record
        ...
        if (nameOfOtherFood.getText().toString().matches("")) {
            Toast.makeText(getActivity(), "Please enter the name of dish/ingredient ", Toast.LENGTH_SHORT).show();
            return;
        }
...
//reset the red, green, yellow button
        ...
        ((EditText) rootview.findViewById(R.id.totalGram)).setText("");
        ((EditText) rootview.findViewById(R.id.nameOfOtherFood)).setText("");
        ((EditText) rootview.findViewById(R.id.caloriesOfOtherFood)).setText("");
//reset the field of editText
    ...
    public void clickGreen(View v) {
        ...
        Toast.makeText(getActivity(), "Good! A normal adult needs around 2500 calories per day, you still can absorb " + format.format(2500 - value) + " more calories today.", Toast.LENGTH_LONG).show();
    }

    public void clickYellow(View v) {
        Toast.makeText(getActivity(), "Perfect! A normal adult needs around 2500 calories per day", Toast.LENGTH_LONG).show();
    }

    public void clickRed(View v) {
        DecimalFormat format = new DecimalFormat("#.#");
        Toast.makeText(getActivity(), "Warning! A normal adult needs around 2500 calories per day, you are absorbing  " + format.format(value - 2500) + " more calories than you are needed!", Toast.LENGTH_LONG).show();
    }
...
// allow user to check the input record
    ...
    public void clickSeasoning(View v) {
        ...
        Button myBtn = (Button) rootview.findViewById(R.id.sugar);
        myBtn.requestFocus();

        Button button = (Button) rootview.findViewById(R.id.sugar);
        button.setFocusable(true);
        button.setFocusableInTouchMode(true);///add getActivity() line
        button.requestFocus();
    }
// redirect user to the desired type of food
    ...
    public void clickVegetable(View v) {
        ...
        Button myBtn = (Button) rootview.findViewById(R.id.mushroom);
        myBtn.requestFocus();

        Button button = (Button) rootview.findViewById(R.id.mushroom);
        button.setFocusable(true);
        button.setFocusableInTouchMode(true);///add getActivity() line
        button.requestFocus();
    }
    ...
    public void clickMeat(View v) {
        ...
        Button myBtn = (Button) rootview.findViewById(R.id.beef);
        myBtn.requestFocus();

        Button button = (Button) rootview.findViewById(R.id.beef);
        button.setFocusable(true);
        button.setFocusableInTouchMode(true);///add getActivity() line
        button.requestFocus();
    }
    public void clickCereal(View v) {
        ...
        Button myBtn = (Button) rootview.findViewById(R.id.rice);
        myBtn.requestFocus();

        Button button = (Button) rootview.findViewById(R.id.rice);
        button.setFocusable(true);
        button.setFocusableInTouchMode(true);///add getActivity() line
        button.requestFocus();
    }
    public void clickSeafood(View v) {
        ...
        Button myBtn = (Button) rootview.findViewById(R.id.fish);
        myBtn.requestFocus();

        Button button = (Button) rootview.findViewById(R.id.fish);
        button.setFocusable(true);
        button.setFocusableInTouchMode(true);///add getActivity() line
        button.requestFocus();
    }
